...
class ContentBlock extends yupe\models\YModel
{
    ...
    {
        return [
            ['name, code, content, content2, content3, content4, type', 'filter', 'filter' => 'trim'],
            ...
            [
                ...
                'match',
                'pattern' => '/^[a-z]{2}$/',
                'message' => 'Bad characters in {attribute} field',
            ],
...
//            ['code', 'unique'],
            ['image', 'safe'],
            ['id, name, code, type, content, description, category_id, status, lang', 'safe', 'on' => 'search'],
        ];
    }
    ...
    {
        $module = Yii::app()->getModule('contentblock');
    ...
    public function attributeLabels()
    {
        return [
            ...
            'content2' => Yii::t('ContentBlockModule.contentblock', 'Content two'),
            'content3' => Yii::t('ContentBlockModule.contentblock', 'Content three'),
            'content4' => Yii::t('ContentBlockModule.contentblock', 'Content foo'),
            ...
            'lang' => Yii::t('ContentBlockModule.contentblock', 'Language'),
        ];
    }
    ...
    public function search()
    {
        ...
        $criteria->compare($this->tableAlias . '.lang', $this->lang);
    ...
    public function listBlocks($lang){
        $criteria = new CDbCriteria();
