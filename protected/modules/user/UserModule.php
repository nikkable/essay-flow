...
class UserModule extends WebModule
{
     ...
     * @var int
     */
    public $registrationAuthorDisabled = 0;
    /**
     * @var int
     */
    ...
    public function getParamsLabels()
    {
        return [
            ...
            'registrationAuthorDisabled' => Yii::t('UserModule.user', 'Disable author registration'),
    ...
    public function getEditableParams()
    {
        return [
            ...
            'registrationAuthorDisabled' => $this->getChoice(),
            'notifyEmailFrom',
            'logoutSuccess',
            'loginSuccess',
