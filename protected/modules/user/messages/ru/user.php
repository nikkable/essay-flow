...
return [
    ...
    'Avatar' => 'Аватар',
    'Wrong field format for "{attribute}". You can use only letters and digits from 2 to 20 symbols' => 'Неверный формат поля "{attribute}" допустимы только буквы и цифры, от 2 до 20 символов',
    ...
    'Status' => 'Статус',
    'The entry is successfully deleted.' => 'Запись успешно удалена',
    ...
    'Yes' => 'Да',
    'Account activated! You can log in now!' => 'Вы успешно активировали аккаунт! Теперь Вы можете войти!',
    ...
    'You can\'t delete an user.' => 'Вы не можете удалить пользователя. Сначала удалите связанные с ним записи.',
