        ...
        if (Yii::app()->getRequest()->getIsPostRequest() && !empty($_POST['LoginForm'])) {
            ...
            if (Yii::app()->authenticationManager->login(
                ...
                Yii::app()->getUser()->setFlash(
                    ...
                    Yii::t('OtherModule.other', 'You authorized successfully!')
                );
                ...
                if($redirect === (Yii::app()->getLanguage() !== 'en' ? '/'.Yii::app()->getLanguage() : '') . '/store/order/create') {
                    $redirect = (Yii::app()->getLanguage() !== 'en' ? '/'.Yii::app()->getLanguage() : '') . '/cart';
                }
                ...
                $form->addError('email', Yii::t('OtherModule.other', 'Email or password was typed wrong!'));
