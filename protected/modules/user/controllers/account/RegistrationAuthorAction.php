 ...
 */
class RegistrationAuthorAction extends CAction
{
    /**
    ...
    public function run()
    {
        if(!Yii::app()->getModule('yupe')->authorRegistration) {
            throw new CHttpException(404, Yii::t('OtherModule.other', 'requested page was not found!'));
        }
        ...
        if ($module->registrationAuthorDisabled) {
            throw new CHttpException(404, Yii::t('OtherModule.other', 'requested page was not found!'));
        }
        ...
        if (($data = Yii::app()->getRequest()->getPost('RegistrationForm')) !== null) {
            ...
            if ($form->validate()) {
                ...
                if ($user = Yii::app()->userManager->createUser($form)) {
                    ...
                    $assign->itemname = AuthItem::ROLE_AUTHOR;
                    ...
                    Yii::app()->getUser()->setFlash(
                        ...
                        Yii::t('OtherModule.other', 'Account was created! Check your email!')
                    );
                ...
                Yii::app()->getUser()->setFlash(
                    ...
                    Yii::t('OtherModule.other', 'Error creating account!')
                );
            }
        }
