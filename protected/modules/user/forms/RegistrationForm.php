...
class RegistrationForm extends CFormModel
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [
                ...
                'message' => Yii::t('OtherModule.other', 'Check code incorrect')
            ],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'password' => Yii::t('OtherModule.other', 'Password'),
    ...
    public function checkNickName($attribute, $params)
    {
        ...
        if ($model) {
            $this->addError('nick_name', Yii::t('OtherModule.other', 'User name already exists'));
        }
    }
    ...
    public function checkEmail($attribute, $params)
    {
        ...
        if ($model) {
            $this->addError('email', Yii::t('OtherModule.other', 'Email already busy'));
        }
    }
