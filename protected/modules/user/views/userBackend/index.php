...
<?php $this->widget(
    ...
    [
        ...
        'columns'      => [
            ...
            [
                'header' => Yii::t('UserModule.user', 'User Role'),
                'type'  => 'raw',
                'value' => '$data->getAssignedRolesNames()',
            ],
            [
            ...
            [
                ...
                'editable' => [
                    ...
                    'title'  => Yii::t(
                        'UserModule.user',
                        'Select {field}',
                        ['{field}' => mb_strtolower($model->getAttributeLabel('author_verification_status'))]
                    ),
                    'source' => $model->getAuthorVerificationStatusList(),
                    'params' => [
                        Yii::app()->getRequest()->csrfTokenName => Yii::app()->getRequest()->csrfToken
                    ]
                ],
                'name'     => 'author_verification_status',
                'type'     => 'raw',
                'value'    => '$model->author_verification_status ? $data->getAuthorVerificationStatus() : null',
                'filter'   => CHtml::activeDropDownList(
                    $model,
                    'author_verification_status',
                    $model->getAuthorVerificationStatusList(),
                    ['class' => 'form-control', 'empty' => '']
                ),
            ],
            [
