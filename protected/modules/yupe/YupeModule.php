...
class YupeModule extends WebModule
{
     ...
     * @var int
     */
    public $authorRegistration = 0;

    /**
     * @var int
     */
    public $authorAutoPayment = 0;
    ...
    public function getParamsLabels()
    {
        return [
            ...
            'authorRegistration' => Yii::t('OrderModule.order', 'Author registration'),
            'authorAutoPayment' => Yii::t('OrderModule.order', 'Author auto payment'),
        ];
    }
...
//            'maxSize',
//            'defaultImage',
            'authorRegistration' => $this->getChoice(),
            'authorAutoPayment' => $this->getChoice(),
        ];
    }
...
//                    'coreCacheTime',
    ...
    {
        return '/backend/modulesettings?module=yupe';
    }
...
//            ],
    ...
    {
        return Yii::t('YupeModule.yupe', 'Settings');
    }
