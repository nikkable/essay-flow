...
class KatarunApi {
	...
	public function __construct($brandId, $apiKey, $base = 'https://gate.katarun.com/api/v1/', $config = []) {
	...
	/**
	 * 
	 * @param \Katarun\Model\Purchase $purchase
	 * @return \Katarun\Model\Purchase
	 */
