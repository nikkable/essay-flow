...
$this->breadcrumbs = [
    Yii::t('OrderModule.order', 'Orders Authors') => ['/order/orderBackend/index'],
...
<div>
    <h1>
        <?= Yii::t('OrderModule.order', 'Orders Authors'); ?>
...
$this->widget(
    ...
    [
        ...
        'columns' => [
            ...
            [
                'name' => 'total_price',
                'header' => Yii::t('OrderModule.order', 'Total price without discount'),
                'value' => function ($data) {
...
//                    return $data->delivery ? $data->delivery->name : '';
//                },
//            ],
//            [
//                'name' => 'manager_id',
...
//                'type' => 'raw',
//                'value' => function ($data) {
//                    return$data->file ? CHtml::link('Open', $data->getFilePath()) : null;
//                },
//            ],
//            'tax',
            [
