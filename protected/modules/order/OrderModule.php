...
class OrderModule extends WebModule
{
    ...
    public $uploadPath = 'order';
    /**
     * @var string
     */
    public $allowedExtensions = 'jpg,jpeg,png,gif,txt,doc,docx,pdf';
    /**
     * @var int
     */
    public $minSize = 0;
    ...
    public function getParamsLabels()
    {
        return [
            ...
            'perPage' => Yii::t('OrderModule.order', 'Orders user per page'),
            'tax' => Yii::t('OrderModule.order', 'Tax'),
            'commission' => Yii::t('OrderModule.order', 'Platform commission'),
        ];
    }
    ...
    public function getNavigation()
    {
        return [
            ...
            [
                'icon' => 'fa fa-fw fa-gift',
                'label' => Yii::t('OrderModule.order', 'Orders Authors'),
                'url' => ['/order/orderBackend/authors'],
            ],
            [
                'icon' => 'fa fa-fw fa-gift',
                'label' => Yii::t('OrderModule.order', 'Author payments'),
                'url' => ['/order/orderBackend/authorsPayments'],
            ],
            [
