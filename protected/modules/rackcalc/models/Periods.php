...
/**
 * This is the model class for table "{{rc_periods}}".
 *
 * The followings are the available columns in table '{{rc_periods}}':
 * @property integer $id
 ...
 *
 */
class Periods extends yupe\models\YModel
{
	/**
	...
	public function rules()
	{
        return [
            ['name', 'length', 'max' => 255],
            ['cost', 'length', 'max' => 6],
            ['desc, desc_small', 'filter', 'filter' => 'trim'],
            ['lang', 'length', 'max' => 2],
