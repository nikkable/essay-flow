...
$this->pageTitle = Yii::t('RackcalcModule.rackcalc', 'Number of pages - control');
    ...
    [
        ...
        'columns'      => [
            ...
            [
                ...
                'name'     => 'name',
                'editable' => [
                    'url'    => $this->createUrl('/rackcalc/wordsBackend/inline'),
                    'mode'   => 'inline',
                    'params' => [
    ...
    <div class="modal-dialog" role="document">
        ...
        $form = $this->beginWidget(
            ...
            [
                ...
                'action' => ['/rackcalc/wordsBackend/batch'],
