...
$this->breadcrumbs = [
    ...
    Yii::t('RackcalcModule.rackcalc', 'Subjects'),
];

$this->pageTitle = Yii::t('RackcalcModule.rackcalc', 'Subjects - control');
    ...
    [
        ...
        'actionsButtons' => [
            'add' => CHtml::link(
                ...
                ['/rackcalc/subjectsBackend/create'],
                [
        ...
        'columns'      => [
            ...
            [
                ...
                'name'     => 'name',
                'editable' => [
                    'url'    => $this->createUrl('/rackcalc/subjectsBackend/inline'),
                    'mode'   => 'inline',
                    'params' => [
    ...
    <div class="modal-dialog" role="document">
        ...
        $form = $this->beginWidget(
            ...
            [
                ...
                'action' => ['/rackcalc/subjectsBackend/batch'],
