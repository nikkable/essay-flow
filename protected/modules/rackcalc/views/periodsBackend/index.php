...
$this->pageTitle = Yii::t('RackcalcModule.rackcalc', 'Periods - control');
    ...
    [
        ...
        'actionsButtons' => [
            'add' => CHtml::link(
                ...
                ['/rackcalc/periodsBackend/create'],
                [
        ...
        'columns'      => [
            ...
            [
                ...
                'name'     => 'name',
                'editable' => [
                    'url'    => $this->createUrl('/rackcalc/periodsBackend/inline'),
                    'mode'   => 'inline',
                    'params' => [
    ...
    <div class="modal-dialog" role="document">
        ...
        $form = $this->beginWidget(
            ...
            [
                ...
                'action' => ['/rackcalc/periodsBackend/batch'],
