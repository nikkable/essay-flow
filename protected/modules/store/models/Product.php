...
class Product extends yupe\models\YModel implements ICommentable
{
    ...
    public function rules()
    {
        return [
            [
                'name, title, short_description, slug, price, discount_price, discount, data, status, is_special',
                'filter',
                'filter' => 'trim',
            ],
            [
            ...
            ['name, slug', 'required'],
            [
                'status, is_special, producer_id, type_id, in_stock, category_id, periods_id, subjects_id, words_id, language_id',
                'numerical',
                'integerOnly' => true,
            ],
            ...
            ['meta_canonical', 'url'],
            [
                'id, type_id, producer_id, sku, name, slug, price, discount_price, discount, short_description, description, data, is_special, length, height, width, weight, quantity, in_stock, status, create_time, update_time, meta_title, meta_description, meta_keywords, category_id, periods_id, subjects_id, words_id, language_id',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function relations()
    {
        return [
            ...
            'period' => [self::BELONGS_TO, 'Periods', 'periods_id'],
            'subject' => [self::BELONGS_TO, 'Subjects', 'subjects_id'],
            'word' => [self::BELONGS_TO, 'Words', 'words_id'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'periods_id' => Yii::t('StoreModule.store', 'Rackcalc period Id'),
            'subjects_id' => Yii::t('StoreModule.store', 'Rackcalc subject Id'),
            'words_id' => Yii::t('StoreModule.store', 'Rackcalc word Id'),
            'language_id' => Yii::t('StoreModule.store', 'Rackcalc language Id'),
        ];
    }
