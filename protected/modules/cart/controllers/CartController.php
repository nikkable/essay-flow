...
class CartController extends FrontController
{
    ...
    public function actionIndex()
    {
        ...
        $order->rackcalcPeriod = Yii::app()->getRequest()->getQuery('rackcalcPeriod');
        $order->rackcalcSubject = Yii::app()->getRequest()->getQuery('rackcalcSubject');
        $order->rackcalcWord = Yii::app()->getRequest()->getQuery('rackcalcWord');
